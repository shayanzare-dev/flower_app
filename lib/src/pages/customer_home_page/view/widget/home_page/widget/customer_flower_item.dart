import 'dart:convert';
import 'package:flower_app/src/pages/customer_home_page/view/widget/home_page/widget/flower_chip_list.dart';
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Obx(() =>
                                _addToCartBtnLoading(flowerItem: flowerItem)),
                          ],
                        ),
                      ],
                    ),
        ...
        Row(
          children: [
            flowerItem.countInStock == 0
                ? Text(
                    LocaleKeys.customer_home_item_out_of_stock.tr,
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: flowerItem.vendorUser.image == ''
                      ...
                      : MemoryImage(base64Decode(flowerItem.vendorUser.image)),
                ),
              ),
